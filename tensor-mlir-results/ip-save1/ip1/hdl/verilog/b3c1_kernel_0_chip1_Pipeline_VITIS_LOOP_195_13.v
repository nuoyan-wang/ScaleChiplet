...
module b3c1_kernel_0_chip1_Pipeline_VITIS_LOOP_195_13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [57:0] sext_ln195;
output  [9:0] v0098_address0;
output   v0098_ce0;
input  [15:0] v0098_q0;
output  [9:0] v0103_address1;
output   v0103_ce1;
output   v0103_we1;
output  [15:0] v0103_d1;
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln195_reg_242;
reg   [0:0] icmp_ln197_reg_256;
reg    ap_predicate_op30_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln195_fu_156_p2;
...
reg   [0:0] icmp_ln195_reg_242_pp0_iter1_reg;
reg   [9:0] v0103_addr_reg_251;
reg   [9:0] v0103_addr_reg_251_pp0_iter1_reg;
wire   [0:0] icmp_ln197_fu_178_p2;
reg   [0:0] icmp_ln197_reg_256_pp0_iter1_reg;
reg   [511:0] gmem0_addr_read_reg_260;
reg   [511:0] ap_phi_mux_empty_phi_fu_123_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_reg_120;
wire   [511:0] zext_ln195_fu_198_p1;
wire   [63:0] zext_ln195_1_fu_168_p1;
reg   [495:0] shiftreg8_fu_72;
wire    ap_loop_init;
reg   [9:0] v0104_fu_76;
wire   [9:0] add_ln195_fu_162_p2;
reg   [9:0] ap_sig_allocacmp_v0104_1;
reg    v0098_ce0_local;
reg    v0103_we1_local;
wire   [15:0] tmp_s_fu_129_p4;
reg    v0103_ce1_local;
wire   [15:0] tmp_s_fu_129_p2;
wire   [4:0] trunc_ln195_fu_174_p1;
reg    ap_done_reg;
...
#0 shiftreg8_fu_72 = 496'd0;
#0 v0104_fu_76 = 10'd0;
#0 ap_done_reg = 1'b0;
end

b3c1_floatingpoint_mul_16ns_16ns_16ns_32ns_16_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .dout_WIDTH( 16 ))
floatingpoint_mul_16ns_16ns_16ns_32ns_16_1_1_U63(
    .din0(v0098_q0),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            shiftreg8_fu_72 <= 496'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            shiftreg8_fu_72 <= {{ap_phi_mux_empty_phi_fu_123_p4[511:16]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln195_fu_156_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        v0103_addr_reg_251 <= zext_ln195_1_fu_168_p1;
        v0103_addr_reg_251_pp0_iter1_reg <= v0103_addr_reg_251;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln195_fu_156_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((icmp_ln195_reg_242_pp0_iter1_reg == 1'd0)) begin
        if ((icmp_ln197_reg_256_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_phi_fu_123_p4 = zext_ln195_fu_198_p1;
        end else if ((icmp_ln197_reg_256_pp0_iter1_reg == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_v0104_1 = 10'd0;
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        v0098_ce0_local = 1'b1;
    end else begin
        v0098_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        v0103_ce1_local = 1'b1;
    end else begin
        v0103_ce1_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        v0103_we1_local = 1'b1;
    end else begin
        v0103_we1_local = 1'b0;
    end
end
...
assign add_ln195_fu_162_p2 = (ap_sig_allocacmp_v0104_1 + 10'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op30_read_state2 == 1'b1) & (m_axi_gmem0_0_RVALID == 1'b0));
end
...
always @ (*) begin
    ap_predicate_op30_read_state2 = ((icmp_ln197_reg_256 == 1'd1) & (icmp_ln195_reg_242 == 1'd0));
end

assign ap_ready = ap_ready_sig;

assign icmp_ln195_fu_156_p2 = ((ap_sig_allocacmp_v0104_1 == 10'd768) ? 1'b1 : 1'b0);

assign icmp_ln197_fu_178_p2 = ((trunc_ln195_fu_174_p1 == 5'd0) ? 1'b1 : 1'b0);
...
assign trunc_ln195_fu_174_p1 = ap_sig_allocacmp_v0104_1[4:0];

assign v0098_address0 = zext_ln195_1_fu_168_p1;

assign v0098_ce0 = v0098_ce0_local;

assign v0103_address1 = v0103_addr_reg_251_pp0_iter1_reg;

assign v0103_ce1 = v0103_ce1_local;

assign v0103_d1 = tmp_s_fu_129_p4;

assign v0103_we1 = v0103_we1_local;

assign zext_ln195_1_fu_168_p1 = ap_sig_allocacmp_v0104_1;

assign zext_ln195_fu_198_p1 = shiftreg8_fu_72;

endmodule //b3c1_kernel_0_chip1_Pipeline_VITIS_LOOP_195_13

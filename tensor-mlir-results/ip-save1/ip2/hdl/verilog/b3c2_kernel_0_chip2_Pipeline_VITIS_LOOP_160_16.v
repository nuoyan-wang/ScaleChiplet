...
module b3c2_kernel_0_chip2_Pipeline_VITIS_LOOP_160_16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [57:0] sext_ln160;
output  [9:0] v0073_address0;
output   v0073_ce0;
input  [15:0] v0073_q0;
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln162_reg_234;
reg   [0:0] icmp_ln162_reg_234_pp0_iter2_reg;
reg    ap_block_state4_io_grp1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln160_fu_124_p2;
...
wire   [0:0] icmp_ln162_fu_145_p2;
reg   [0:0] icmp_ln162_reg_234_pp0_iter1_reg;
reg   [15:0] v0073_load_reg_239;
wire   [63:0] zext_ln160_fu_136_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [495:0] phi_ln162_fu_72;
wire   [495:0] select_ln162_fu_193_p3;
wire    ap_loop_init;
reg   [9:0] v0078_fu_76;
wire   [9:0] add_ln160_fu_130_p2;
reg   [9:0] ap_sig_allocacmp_v0078_1;
reg    v0073_ce0_local;
wire   [4:0] trunc_ln160_fu_141_p1;
wire   [479:0] tmp_s_fu_176_p4;
wire   [495:0] tmp_8_fu_186_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln160_fu_124_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln160_fu_124_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_v0078_1 = 10'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp1) & (icmp_ln162_reg_234_pp0_iter2_reg == 1'd1) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (icmp_ln162_reg_234_pp0_iter2_reg == 1'd1) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        v0073_ce0_local = 1'b1;
    end else begin
        v0073_ce0_local = 1'b0;
    end
end
...
assign add_ln160_fu_130_p2 = (ap_sig_allocacmp_v0078_1 + 10'd1);
...
always @ (*) begin
    ap_block_state4_io_grp1 = ((icmp_ln162_reg_234_pp0_iter2_reg == 1'd1) & (m_axi_gmem0_0_WREADY == 1'b0));
end
...
assign icmp_ln160_fu_124_p2 = ((ap_sig_allocacmp_v0078_1 == 10'd768) ? 1'b1 : 1'b0);

assign icmp_ln162_fu_145_p2 = ((trunc_ln160_fu_141_p1 == 5'd31) ? 1'b1 : 1'b0);
...
assign m_axi_gmem0_0_WDATA = {{v0073_load_reg_239}, {phi_ln162_fu_72}};

assign m_axi_gmem0_0_WID = 1'd0;

assign m_axi_gmem0_0_WLAST = 1'b0;

assign m_axi_gmem0_0_WSTRB = 64'd18446744073709551615;

assign m_axi_gmem0_0_WUSER = 1'd0;

assign select_ln162_fu_193_p3 = ((icmp_ln162_reg_234_pp0_iter2_reg[0:0] == 1'b1) ? 496'd0 : tmp_8_fu_186_p3);

assign tmp_8_fu_186_p3 = {{v0073_load_reg_239}, {tmp_s_fu_176_p4}};

assign tmp_s_fu_176_p4 = {{phi_ln162_fu_72[495:16]}};

assign trunc_ln160_fu_141_p1 = ap_sig_allocacmp_v0078_1[4:0];

assign v0073_address0 = zext_ln160_fu_136_p1;

assign v0073_ce0 = v0073_ce0_local;

assign zext_ln160_fu_136_p1 = ap_sig_allocacmp_v0078_1;

endmodule //b3c2_kernel_0_chip2_Pipeline_VITIS_LOOP_160_16
